...
#ifndef APPYLAR_SWIFT_H
#define APPYLAR_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Appylar",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC7Appylar13Advertisement")
...
SWIFT_CLASS("_TtC7Appylar10BannerView")
@interface BannerView : UIView <SFSafariViewControllerDelegate>
...
@interface BannerView (SWIFT_EXTENSION(Appylar)) <WKNavigationDelegate, WKScriptMessageHandler, WKUIDelegate>
- (void)userContentController:(WKUserContentController * _Nonnull)userContentController didReceiveScriptMessage:(WKScriptMessage * _Nonnull)message;
/// *Perform navigation of webview on safari *
/// <em>Return wkWebView</em>
...
SWIFT_CLASS("_TtC7Appylar26InterstitialViewController")
...
@interface InterstitialViewController (SWIFT_EXTENSION(Appylar)) <SFSafariViewControllerDelegate, WKScriptMessageHandler>
- (void)userContentController:(WKUserContentController * _Nonnull)userContentController didReceiveScriptMessage:(WKScriptMessage * _Nonnull)message;
/// *Perform navigation of webview on safari *
/// <em>Return wkWebView</em>
- (WKWebView * _Nullable)webView:(WKWebView * _Nonnull)webView createWebViewWithConfiguration:(WKWebViewConfiguration * _Nonnull)configuration forNavigationAction:(WKNavigationAction * _Nonnull)navigationAction windowFeatures:(WKWindowFeatures * _Nonnull)windowFeatures SWIFT_WARN_UNUSED_RESULT;
